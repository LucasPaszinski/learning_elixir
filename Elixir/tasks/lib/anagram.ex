...
Enum.map(1..4, &"./lib/word_list/list#{&1}.txt")
|> WordListLoader.load_files
anagrams = Dictionary.anagrams_of("organ")
IO.puts "Number of Angrams: #{length(anagrams)}"
Enum.map anagrams, &IO.puts("#{&1}")
